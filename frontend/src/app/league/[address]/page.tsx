// src/app/league/[address]/page.tsx
'use client';
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#0b0b14] to-black text-white px-6 py-10">
      <div className="mx-auto max-w-4xl">
        {/* Header */}
        <h1 className="text-center text-4xl font-extrabold tracking-tight">{name || 'League'}</h1>
        ...
        {/* Centered, smaller stat cards; "Draft Status" label */}
